  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      image: 'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/fran%20jpeg.jpg',
      icon: (
    ...
    },
    {
      ...
      image: 'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/fransesc%20Jpeg.jpg ',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
    ...
    },
    {
      ...
      image: 'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/alvaro%20jpeg.jpg',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
