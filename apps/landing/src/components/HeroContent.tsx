...
const HeroContent: React.FC = () => {
  ...
  const carImages = [
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/N_GCD5c6bmu_qSm2vy5aXhUn2XZ06ssmVz1n8WQ2yAU.jpeg',
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/WhatsApp%20Image%202025-09-11%20at%2016.54.55.jpeg',
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/JlIt1DBPAoHsg0E2I9p-tUt5fyO5B4Vgq12Bigt1g_Q.jpeg',
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/kcHmycLW-elCaLZFittUBm25DsxblBh78XEnVKW_igQ-2%20(2).jpeg',
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/L2MqiVW5cS1nctrpDp68hiDEKOWrCR0Qu0FAdmWIXrs.jpeg',
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/UjQALZ4Q1gQm5sD7rBP4ZB0IvM6R-xMl0shyxLuWax4%20(1).jpeg',
'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/7slmTFCh5DzqekBFk3U9cHVY8X84GKPp05zvxSpy6SU%20(1).jpeg'
  ];
        ...
        <div className="relative">
          <div className="lg:grid lg:grid-cols-[1.4fr_420px] xl:grid-cols-[1.5fr_480px] lg:gap-8 xl:gap-10 items-center">
            <div className="space-y-4 lg:space-y-6 lg:max-w-none">
              ...
              >
                <div className="flex items-center gap-2 px-4 py-2 bg-white text-black text-xs lg:text-sm font-semibold rounded-full inline-flex animate-fade-in-up shadow-lg border-2 border-black">
                  <svg className="w-3 h-3 lg:w-4 lg:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                  AQUÍ TERMINA LA FALTA DE TRANSPARENCIA
                </div>

                <p className="text-sm lg:text-base text-gray-800 font-medium leading-relaxed max-w-[400px] lg:max-w-[500px]">
MÁS DE 100 PERSONAS YA HAN AHORRADO MILES DE EUROS{' '}
                  <span className="font-bold text-gray-900">IMPORTANDO CON NOSOTROS.</span>
                </p>
              </div>
            </div>

            <div
              className={`relative mt-8 lg:mt-0 h-[320px] lg:h-[700px] xl:h-[850px] lg:-ml-12 xl:-ml-16 transition-all duration-1800 ease-out ${
              ...
              <div className="absolute inset-0 flex items-center justify-center perspective-1000">
                {carImages.map((image, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="absolute w-[240px] h-[170px] sm:w-[300px] sm:h-[210px] lg:w-[480px] lg:h-[340px] xl:w-[550px] xl:h-[390px] transition-all duration-1000 ease-out"
                      style={{
