...
const HeroImage: React.FC<HeroImageProps> = ({ mousePosition }) => {
  ...
  const carImages = [
    {
      url: 'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/N_GCD5c6bmu_qSm2vy5aXhUn2XZ06ssmVz1n8WQ2yAU.jpeg',
      caption: 'BMW Serie 5',
      year: '2022'
    },
    {
      url: 'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/WhatsApp%20Image%202025-09-11%20at%2016.54.55.jpeg',
    ...
    {
      url: 'https://hrsmkynojqkefoubxwqn.supabase.co/storage/v1/object/public/fotos%20coches/7slmTFCh5DzqekBFk3U9cHVY8X84GKPp05zvxSpy6SU%20(1).jpeg',
